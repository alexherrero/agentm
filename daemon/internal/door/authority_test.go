...
func TestAuthorityMatrix(t *testing.T) {
	...
	cases := []struct {
		...
		{"the reference library is a shared surface, no grant needed",
			"resources/topics/sqlite/bm25-k1-b-constants.md", false, none, Standing, "shared surface"},
		{"a system's page is a shared surface, no grant needed",
			"systems/x.md", false, none, Standing, "shared surface"},
		{"a system's component is a shared surface, and an edit needs no grant either",
			"systems/homelab/components/nas-backup.md", true, none, Standing, "shared surface"},
		...
		{"a new root document under a grant asks: the root holds five files",
			"projects/agentm/decisions.md", false, agentm, Alignment, "holds five files"},
		{"a missing front-page file under a grant is standing",
			"projects/agentm/blueprint.md", false, agentm, Standing, "one of the five"},
		{"a new document in docs/ under a grant is standing",
			"projects/agentm/docs/decisions.md", false, agentm, Standing, "maintains freely"},
