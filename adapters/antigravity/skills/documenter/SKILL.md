...
Canonical spec: [`harness/agents/documenter.md`](../../../../harness/agents/documenter.md). Convention: [`harness/documentation.md`](../../../../harness/documentation.md).
...
Everything else is off-limits. No source code. No `.harness/PLAN.md`, `features.json`, or `progress.md`. No `AGENTS.md` or repo-root files.
...
| Workflow | When | Goal | Write targets |
|---|---|---|---|
