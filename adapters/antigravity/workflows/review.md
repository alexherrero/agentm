...
8. **Do NOT dispatch crickets' `wiki-maintenance:documenter` sub-agent.** Doc drift is `/release`'s concern; surfacing it here as a finding is fine, acting on it is not.
