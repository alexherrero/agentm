...
class TestSingleRules(unittest.TestCase):
    ...
    def test_vault_content_conventions_in_docs(self):
        """A vault project keeps `conventions.md` in `docs/` (task 176), and
        that is the shape detection reads; a root copy is not the shape."""
        with _TmpRepo() as root:
