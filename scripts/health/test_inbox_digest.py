...
class WriteDigestNoteTests(unittest.TestCase):
    ...
    def test_writes_note_with_expected_frontmatter(self):
        ...
        self.assertEqual(target.parent, self.vault / "diagnostics/digests")
    ...
    def test_same_day_rerun_does_not_duplicate(self):
        ...
        files = list((self.vault / "diagnostics/digests").glob("*digest-daily*"))
...
class MainCliTests(unittest.TestCase):
    ...
    def test_main_writes_a_note(self):
        ...
        self.assertTrue(list((self.vault / "diagnostics/digests").glob("*.md")))
