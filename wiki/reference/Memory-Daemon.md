...
Step 3 already moved the living documents that used to sit at a project root (`followups.md`, `roadmap.md`, and others) to `docs/`, and the config and source lists to `desk/`. `project.yaml`, `blueprint.md`, and a regenerated `tracker.md` are step 5's job.
