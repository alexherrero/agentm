...
| Exclusion dirs | N/A | `_EXCLUDE_DIRS` (`frontmatter_validator.py`) mirrors `vault_lint.py`'s own `_EXCLUDE_DIRS` exactly (DC-4): `_idea-incubator, _meta, _harness, _inbox, scratch, _archive, _opinions, _crystallize-staging` |
