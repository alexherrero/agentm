...
|---|---|---|
| [`[T] Linux Tests`](https://github.com/alexherrero/agentm/blob/main/.github/workflows/tests-linux.yml) | `ubuntu-latest` | install-smoke + adapter-parity + validate + check-references + check-wiki + unit tests + **verify-v4** + **check-vault-lock-parity** + **verify-orchestration-briefing** + **verify-phases** + **verify-memory-roundtrip** + syntax + **lib-parity** + **pii-guardrails** (check-no-pii + gitleaks) + dogfood-workflows |
| [`[T] Mac Tests`](https://github.com/alexherrero/agentm/blob/main/.github/workflows/tests-mac.yml) | `macos-latest` | install-smoke + validate + check-references + unit tests + **verify-v4** + **check-vault-lock-parity** + **verify-orchestration-briefing** + **verify-phases** + **verify-memory-roundtrip** + syntax (both shells) + **lib-parity** + **check-no-pii** |
