...
The five V5 roadmap arcs (V5-0 / V5-1 / V5-4 / V5-10 + the seven-section-convergence + dev-loop-slim breaking work). Three ADRs cover the wave: [ADR 0011](0011-v5-unbundling-dev-loop) (unbundling, 2026-06-11), [ADR 0012](memory-storage-seam) (vault-write protocol, 2026-06-12), and [ADR 0013](memory-storage-seam) (storage-seam fail-loud selection, added in this release sweep, 2026-06-13).

### Related

- [ADR 0013 — Storage-seam fail-loud selection](memory-storage-seam) · [ADR 0012 — Vault-write protocol](memory-storage-seam) · [ADR 0011 — V5 unbundling](0011-v5-unbundling-dev-loop)
