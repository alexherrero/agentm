...
| FRIDAY | Hold lifted; the ladder is running — feature 1 of 7 (Delivery channels) shipped; the capture trilogy (features 2–4 of 7: front door, article ingestion, the ingest sweep) fully shipped; feature 5 of 7 (auto-organization part 1, the tidying stage) shipped | v8.3.0 → v8.7.0 (in progress) | — |
