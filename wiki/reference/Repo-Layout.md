...
The top-level layout of agentm on disk. For *why* this shape, see [How the pieces fit](How-The-Pieces-Fit), [ADR 0001](0001-phase-gated-workflow), and [ADR 0002](seven-section-convergence).
