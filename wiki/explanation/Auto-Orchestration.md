...
- **At the phase boundaries**, a finished `/work` session gets reflected and a finished `/release` refreshes the skill surfaces — without you running `reflect` or `index-skills` by hand.
