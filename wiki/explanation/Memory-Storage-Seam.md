...
Like device-local, the vault backend *exists and works* but the live engine does not yet use it — pointing the public API at a chosen backend is part 5.
