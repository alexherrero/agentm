...
> [!NOTE]
> **Status: implemented** (2026-06-13, updated 2026-09-13). The multi-plan-state substrate — the round-trip lock, `resolve_active_plan`, the `check-multi-plan-naming` gate — ships in `main`; crickets' development-lifecycle plugin writes the `.harness/active-plan` marker this page's reader consumes. See Build history below for the rollout, the 2026-07-06 worktree-native update, and the 2026-09-13 addition of the task-layout plan and the tracker.
