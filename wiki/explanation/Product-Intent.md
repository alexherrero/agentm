...
- **Dynamic doc generation from code.** Docs are human-edited narrative, refreshed by the `documenter` at phase boundaries only — see [ADR 0002](0002-documentation-convention).
