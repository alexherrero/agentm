...
**Cross-design pointer:** ADR 0018's "re-audit if `personal-private/` → `personal/` rename ships" trigger fired in V5-3. See [ADR 0010](../decisions/0010-vault-internal-taxonomy.md) (vault taxonomy, not folded here).
...
**Cross-design pointer:** ADR 0018 DC-7's `personal-private/` → `personal/` rename fires ADR 0010's first load-bearing assumption re-audit trigger — see [ADR 0010 — Vault internal taxonomy](../decisions/0010-vault-internal-taxonomy.md).
