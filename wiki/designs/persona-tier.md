...
3. **`enhances:` reuse, not a `composes:` alias.** ✓ The AgentM HLD already owns the soft-composition field + runtime; the semantics a persona needs (optional, present-or-absent, degrade) are identical. Reuse; do not alias.
