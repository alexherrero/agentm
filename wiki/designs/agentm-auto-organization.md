...
*Task 3 of 7 (the write-time linker itself) shipped 2026-07-18 — see the as-built note after the paragraph below for how its timing actually works. Tasks 4, 5, and 6 (the weekly link-improvement sweep, the ingest-batch handoff, and the backfill) have since shipped too, each with its own as-built note. The connectivity meter (task 7) is all that remains designed-for.*
