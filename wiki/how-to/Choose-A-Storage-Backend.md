...
- [The memory↔storage seam](Storage-Seam-Concepts) — why selection fails loud instead of demoting, and why the engine cutover is deferred beyond V5-1.
